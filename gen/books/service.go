...
// CreateBookPayload is the payload type of the books service create-book
// method.
...
// Createbookresponse is the result type of the books service create-book
// method.
...
// DeleteBookPayload is the payload type of the books service delete-book
// method.
...
// GetBookPayload is the payload type of the books service get-book method.
type GetBookPayload struct {
	// Book id
	ID int
}

// GetBooksPayload is the payload type of the books service get-books method.
...
// Getbookresponse is the result type of the books service get-book method.
...
// Getbooksresponse is the result type of the books service get-books method.
...
// UpdateBookPayload is the payload type of the books service update-book
// method.
...
// Updatebookresponse is the result type of the books service update-book
// method.
...
func NewGetbookresponse(vres *booksviews.Getbookresponse) *Getbookresponse {
...
func NewViewedGetbookresponse(res *Getbookresponse, view string) *booksviews.Getbookresponse {
	p := newGetbookresponseView(res)
	return &booksviews.Getbookresponse{Projected: p, View: "default"}
}

// NewGetbooksresponse initializes result type Getbooksresponse from viewed
// result type Getbooksresponse.
func NewGetbooksresponse(vres *booksviews.Getbooksresponse) *Getbooksresponse {
...
func NewViewedGetbooksresponse(res *Getbooksresponse, view string) *booksviews.Getbooksresponse {
	p := newGetbooksresponseView(res)
	return &booksviews.Getbooksresponse{Projected: p, View: "default"}
}

// NewCreatebookresponse initializes result type Createbookresponse from viewed
// result type Createbookresponse.
func NewCreatebookresponse(vres *booksviews.Createbookresponse) *Createbookresponse {
...
func NewViewedCreatebookresponse(res *Createbookresponse, view string) *booksviews.Createbookresponse {
	p := newCreatebookresponseView(res)
	return &booksviews.Createbookresponse{Projected: p, View: "default"}
}

// NewUpdatebookresponse initializes result type Updatebookresponse from viewed
// result type Updatebookresponse.
func NewUpdatebookresponse(vres *booksviews.Updatebookresponse) *Updatebookresponse {
...
func NewViewedUpdatebookresponse(res *Updatebookresponse, view string) *booksviews.Updatebookresponse {
	p := newUpdatebookresponseView(res)
	return &booksviews.Updatebookresponse{Projected: p, View: "default"}
}

// newGetbookresponse converts projected type Getbookresponse to service type
// Getbookresponse.
func newGetbookresponse(vres *booksviews.GetbookresponseView) *Getbookresponse {
	res := &Getbookresponse{}
	if vres.ID != nil {
		res.ID = *vres.ID
	}
...
func newGetbookresponseView(res *Getbookresponse) *booksviews.GetbookresponseView {
	vres := &booksviews.GetbookresponseView{
		ID:          &res.ID,
		Title:       &res.Title,
		Author:      &res.Author,
...
// Getbooksresponse.
func newGetbooksresponse(vres *booksviews.GetbooksresponseView) *Getbooksresponse {
...
func newGetbooksresponseView(res *Getbooksresponse) *booksviews.GetbooksresponseView {
	vres := &booksviews.GetbooksresponseView{}
	if res.Books != nil {
...
func newResultbookCollection(vres booksviews.ResultbookCollectionView) ResultbookCollection {
...
func newResultbookCollectionView(res ResultbookCollection) booksviews.ResultbookCollectionView {
	vres := make(booksviews.ResultbookCollectionView, len(res))
	for i, n := range res {
...
func newResultbook(vres *booksviews.ResultbookView) *Resultbook {
	res := &Resultbook{}
	if vres.ID != nil {
		res.ID = *vres.ID
	}
...
func newResultbookView(res *Resultbook) *booksviews.ResultbookView {
	vres := &booksviews.ResultbookView{
		ID:          &res.ID,
		Title:       &res.Title,
		Author:      &res.Author,
		BookCover:   &res.BookCover,
...
func newCreatebookresponse(vres *booksviews.CreatebookresponseView) *Createbookresponse {
...
func newCreatebookresponseView(res *Createbookresponse) *booksviews.CreatebookresponseView {
	vres := &booksviews.CreatebookresponseView{
		ID:          &res.ID,
		Title:       &res.Title,
		Author:      &res.Author,
		BookCover:   &res.BookCover,
...
func newUpdatebookresponse(vres *booksviews.UpdatebookresponseView) *Updatebookresponse {
...
func newUpdatebookresponseView(res *Updatebookresponse) *booksviews.UpdatebookresponseView {
	vres := &booksviews.UpdatebookresponseView{
		ID:          &res.ID,
		Title:       &res.Title,
		Author:      &res.Author,
		BookCover:   &res.BookCover,
