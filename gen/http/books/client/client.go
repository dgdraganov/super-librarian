...
func (c *Client) GetBook() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("books", "get-book", err)
		}
...
func (c *Client) GetBooks() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("books", "get-books", err)
		}
		return decodeResponse(resp)
	}
}
...
func (c *Client) CreateBook() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("books", "create-book", err)
		}
		return decodeResponse(resp)
	}
}
...
func (c *Client) UpdateBook() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("books", "update-book", err)
		}
		return decodeResponse(resp)
	}
}
...
func (c *Client) DeleteBook() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("books", "delete-book", err)
		}
		return decodeResponse(resp)
	}
}
