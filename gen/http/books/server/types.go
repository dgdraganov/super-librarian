...
// "get-book" endpoint of the "books" service.
func NewGetBookResponseBody(res *booksviews.GetbookresponseView) *GetBookResponseBody {
...
// "get-books" endpoint of the "books" service.
func NewGetBooksResponseBody(res *booksviews.GetbooksresponseView) *GetBooksResponseBody {
	body := &GetBooksResponseBody{}
	if res.Books != nil {
		body.Books = make([]*ResultbookResponseBody, len(res.Books))
		for i, val := range res.Books {
			body.Books[i] = marshalBooksviewsResultbookViewToResultbookResponseBody(val)
		}
	}
	return body
}
...
func NewCreateBookResponseBody(res *booksviews.CreatebookresponseView) *CreateBookResponseBody {
...
func NewUpdateBookResponseBody(res *booksviews.UpdatebookresponseView) *UpdateBookResponseBody {
...
// NewGetBookPayload builds a books service get-book endpoint payload.
...
// NewGetBooksPayload builds a books service get-books endpoint payload.
func NewGetBooksPayload(skip int, take int) *books.GetBooksPayload {
...
// NewCreateBookPayload builds a books service create-book endpoint payload.
...
// NewUpdateBookPayload builds a books service update-book endpoint payload.
func NewUpdateBookPayload(body *UpdateBookRequestBody) *books.UpdateBookPayload {
...
// NewDeleteBookPayload builds a books service delete-book endpoint payload.
